...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Amosh's personal AI assistant. "
        f"Your job is to help users learn about Amosh's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Amosh. "
        ...
        f"Answer in third person when talking about Amosh, but you may use natural conversational language "
